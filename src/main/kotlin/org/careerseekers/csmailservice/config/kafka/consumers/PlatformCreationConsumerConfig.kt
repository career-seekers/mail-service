...
@Configuration
@EnableKafka
class PlatformCreationConsumerConfig {

    @Value("\${spring.kafka.bootstrap-servers}")
    private lateinit var kafkaUrl: String

    @Bean
    fun platformCreationConsumerFactory(): ConsumerFactory<String, PlatformCreation> {
        val configProps = mapOf(
            ...
            ConsumerConfig.GROUP_ID_CONFIG to "platform_creations_tasks_consumer",
    ...
    fun kafkaListenerContainerFactory(
        consumerFactory: ConsumerFactory<String, PlatformCreation>,
    ): ConcurrentKafkaListenerContainerFactory<String, PlatformCreation> {
        val factory = ConcurrentKafkaListenerContainerFactory<String, PlatformCreation>()
